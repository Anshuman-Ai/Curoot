...
res = supabase.table("magic_link_tokens").select("created_by").eq("token", "IxBWYkX5j0NcYJwwfajPXYfM8wHVYU4fxs3dfDsWOEjLN1HMO2pWuBaesgbuS7ZO").execute()
print('created_by:', res.data)
